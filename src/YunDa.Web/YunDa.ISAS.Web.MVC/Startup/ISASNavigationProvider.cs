...
namespace YunDa.ISAS.Web.MVC.Startup
{
    ...
    /// </summary>
    public class ISASNavigationProvider : NavigationProvider
    {
            ...
            context.Manager.MainMenu
                .AddItem(
                    new MenuItemDefinition(
                        PageNames.Home,
                        new LocalizableString("Home1", "主页1"),
                        url: "/Home/Home",
                        icon: "home",
        ...
        {
            return new LocalizableString(name, ISASConsts.LocalizationSourceName);
        }
    }
}